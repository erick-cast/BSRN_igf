    ...
    def obtener_filtro(self):
        ...
        try:
            inicio = datetime.combine(
                ...
                hours=int(self.hora_ini.get()),
                minutes=int(self.min_ini.get())
            )
            ...
            fin = datetime.combine(
                ...
                hours=int(self.hora_fin.get()),
                minutes=int(self.min_fin.get()),
                seconds=59
            )
        except Exception:
            return None
        ...
        return df_f.copy() if not df_f.empty else None
